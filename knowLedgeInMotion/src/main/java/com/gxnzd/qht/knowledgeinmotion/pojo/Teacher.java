...
public class Teacher {
	...
	public Teacher(String teacherId, Integer collegeId,
				   String mangeClassId, String name, String position,
				   Integer age, Short sex, String phoneNumber, String passWord, String photograph) {
